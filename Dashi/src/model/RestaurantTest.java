...
public class RestaurantTest {
	...
	@Test
	public void testStringToJSONArrayCornerCases() {
		JSONArray jsonArray = new JSONArray();
		assertEquals(jsonArray, Restaurant.stringToJSONArray(""));
		jsonArray.put("Chinese");
		assertEquals(jsonArray, Restaurant.stringToJSONArray("Chinese"));
		jsonArray.put("Japanese");
		jsonArray.put("");
		assertEquals(jsonArray, Restaurant.stringToJSONArray("Chinese,Japanese,"));
	}
